...
tests = {
    ...
    'cat-oci_aran': ('Tinc', 'È'),
    'cat-por': ('tinc', 'tenho'),
    'cat-por_br': ('tinc', 'tenho'),
    'cat-por_BR': ('tinc', 'tenho'),
    'cat-por_PTpre1990': ('tinc', 'tenho'),
    'cat-spa': ('Jo', 'Yo'),
    'cym-eng': ('Yn', 'In'),
    'eng-cat': ('us', 'ens'),
    'eng-cat_iec2017': ('us', 'ens'),
    'eng-cat_valencia': ('us', 'ens'),
    'eng-epo': ('And', 'Kaj'),
    'eng-glg': ('Only', 'Só'),
    'eng-spa': ('hello', 'hola'),
    'epo-eng': ('kaj', 'and'),
    ...
    'ind-zlm': ('sedangkan', 'manakala'),
    'zlm-ind': ('manakala', 'sedangkan'),
